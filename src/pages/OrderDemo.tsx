...
const projectData: HouseItem[] = [
  ...
  { id: 4, code: 'TN04', name: 'AI Trip Map Planner', teamName: 'The-netflix-hermits', style: 'Brutalist Concrete', type: 'travel', color: '#0284c7', progress: 10, deployedUrl: 'https://trip-planner-botnoi.vercel.app/', githubUrl: 'https://github.com', isReady: false },
  ...
  { id: 8, code: 'TN08, TN19', name: 'Chevi Shop', teamName: ['Vibe-architects', 'ocean-avengers'], style: 'Industrial Brickwork', type: 'ecommerce', color: '#0284c7', progress: 75, deployedUrl: 'https://chevi-shop-cupcake.netlify.app/', githubUrl: 'https://github.com', isReady: true },
