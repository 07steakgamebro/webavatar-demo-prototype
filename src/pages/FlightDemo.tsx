...
import { formatDate, formatFlightDuration } from "@/lib/dateUtils";
import {
  ChevronDown, Check,
...
import { TypewriterHeading } from "./flight/components/TypewriterHeading";
import { Field } from "./flight/components/Field";
import { TicketModal } from "./flight/components/TicketModal";
import { SeatMapModal } from "./flight/components/SeatMapModal";
import {
  parseDateForCard,
  getCityLabelForLang,
  getTodayString,
  getNextDayString,
} from "./flight/utils/dateHelpers";
import type { BookingForm, SeatMapLegInfo } from "./flight/types";
import {
  type CityMeta,
  CITIES_CONFIG,
...
export type { SeatMapLegInfo, BookingForm };
